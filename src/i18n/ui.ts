...
export const ui = {
  pt: {
    ...
    'results.docs': 'Documentos',
    'results.col.work': 'Trabalho',
    'results.col.track': 'Trilha',
    'results.col.link': 'Artefato',
    'results.highlights.title': 'Trabalhos Destaque na Categoria Artefatos',
    'results.highlights.bestLead': 'O Comitê de Seleção selecionou o Melhor Artefato do SBRC 2026:',
    'results.highlights.othersLead': 'Também foram selecionados como artefatos destaque:',
    'results.highlights.bestBadge': 'Melhor Artefato',
    'results.highlights.authors': 'Autores',
    'results.highlights.paper': 'Paper (SOL)',
    'results.highlights.repo': 'Repositório',
    'article.eyebrow': 'Na mídia',
    'article.readOriginal': 'Ler na SBC Horizontes',
    'article.originNote': 'Publicado originalmente em português na SBC Horizontes.',
    'article.backHome': '← Início',
    'home.article.kicker': 'Artigo em destaque · SBC Horizontes',
    'home.article.cta': 'Ler artigo',
    'footer.and': 'e',
    'lang.label': 'Idioma',
  },
  en: {
    ...
    'results.highlights.title': 'Highlighted Artifacts',
    'results.highlights.bestLead': 'The Selection Committee chose the Best Artifact of SBRC 2026:',
    'results.highlights.othersLead': 'Also selected as highlighted artifacts:',
    'results.highlights.bestBadge': 'Best Artifact',
    'results.highlights.authors': 'Authors',
    'results.highlights.paper': 'Paper (SOL)',
    'results.highlights.repo': 'Repository',
    'article.eyebrow': 'In the media',
    'article.readOriginal': 'Read on SBC Horizontes',
    'article.originNote': 'Originally published in Portuguese in SBC Horizontes.',
    'article.backHome': '← Home',
    'home.article.kicker': 'Featured article · SBC Horizontes',
    'home.article.cta': 'Read article',
    'footer.and': 'and',
    'lang.label': 'Language',
  },
  es: {
    ...
    'results.highlights.title': 'Artefactos Destacados',
    'results.highlights.bestLead': 'El Comité de Selección eligió el Mejor Artefacto del SBRC 2026:',
    'results.highlights.othersLead': 'También fueron seleccionados como artefactos destacados:',
    'results.highlights.bestBadge': 'Mejor Artefacto',
    'results.highlights.authors': 'Autores',
    'results.highlights.paper': 'Paper (SOL)',
    'results.highlights.repo': 'Repositorio',
    'article.eyebrow': 'En los medios',
    'article.readOriginal': 'Leer en SBC Horizontes',
    'article.originNote': 'Publicado originalmente en portugués en SBC Horizontes.',
    'article.backHome': '← Inicio',
    'home.article.kicker': 'Artículo destacado · SBC Horizontes',
    'home.article.cta': 'Leer artículo',
    'footer.and': 'y',
    'lang.label': 'Idioma',
  },
} as const;
